...
auportsum=`sudo /bin/netstat -anpt | grep -E '29017|29200|29033'|grep -wc [E]STABLISHED|grep -v glinkd`
...
port29033=`sudo /bin/netstat -anpt | grep [2]9033|grep -wc [E]STABLISHED`
