#!/usr/bin/perl -w
use POSIX;
my $mu_ip="/etc/fabu_server_13/ahlm2_dalu/tongbu_script/ahlm2_tencent_list";
my $ssh_kou=22;
my @mu_lu=qw(/export/new_fabu_server/bxzw_server/rsync/ /etc/fabu_server_13/ahlm2_dalu/game_config/ahlm2_tencent_xml/ /etc/fabu_server_13/ahlm2_dalu/tongbu_script/ahlm2_tencent.md5);
...
qx#sh /etc/fabu_server_13/ahlm2_dalu/tongbu_script/ahlm2_clear.sh#;
...
print "=============开始检查MD5=============\n";
system("echo ==============`ssh -p $ssh_kou $ARGV[0] hostname`;ssh $ARGV[0] \"cd /home/super/update/ahlm2package/srcfile ;md5sum -c ./ahlm2_tencent.md5 |grep -iv ok\"");
